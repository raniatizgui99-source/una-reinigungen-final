      ...
      <div id="hero" className="relative pt-32 md:pt-40 pb-24 md:pb-32 px-6 overflow-hidden bg-slate-950 min-h-[95vh] flex flex-col justify-center items-center text-center">
        ...
        <div className="max-w-4xl mx-auto relative z-10 w-full flex flex-col items-center">
          ...
          <div id="quote-form" className="w-full max-w-4xl relative">
             ...
             {/* WhatsApp Hero Button & Urgency */}
             <div className="mt-12 flex flex-col items-center gap-4">
                <span className="text-white/90 font-bold tracking-wide text-sm sm:text-base animate-pulse">
                  ⚡ Antwort in unter 5 Minuten
                </span>
                <a 
                  ...
                  className="inline-flex items-center gap-3 bg-[#25D366] text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-lg md:text-xl hover:scale-105 active:scale-95 hover:shadow-[0_0_40px_rgba(37,211,102,0.6)] transition-all duration-300 shadow-[0_15px_35px_rgba(37,211,102,0.4)] group min-w-[280px] justify-center min-h-[48px]"
                >
                  <svg
                    viewBox="0 0 24 24"
                    width="28"
